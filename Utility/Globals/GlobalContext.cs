...
namespace Utility
{
	public static class GlobalContext
	{
		...
		public static IServiceProvider? GetServiceProvider(Type serviceType)
		{
			...
			if (RootServices != null && Services.Where(u => u.ServiceType == (serviceType.IsGenericType ? serviceType.GetGenericTypeDefinition() : serviceType)).Any(u => u.Lifetime == ServiceLifetime.Singleton))
			{
				return RootServices;
			}
        ...
        public static void DisposeUnmanagedObjects()
        {
            ...
            if (UnmanagedObjects.Any())
            {
                ...
                if ((LastGcCollectTime == null || (nowTime - LastGcCollectTime.Value).TotalSeconds > GcCollectIntervalSeconds))
                {
        ...
        public static string GetVersion()
		{
            ...
            //return DateTime.Today.Ticks + version.ToString();
            return SystemConfig.SystemVersion;
        }
        ...
        public static void LogWhenStart(IWebHostEnvironment env)
		{
            ...
            SerilogHelper.Information(sb.ToString());
		}
